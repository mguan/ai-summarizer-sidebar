...
1.  **Download** the latest release "Source code (zip)" from the [releases page](https://github.com/mguan/ai-summarizer-sidebar/releases) (e.g., https://github.com/mguan/ai-summarizer-sidebar/archive/refs/tags/v0.1.zip) and unzip the file.
